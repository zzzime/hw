...
---------------------------------------------------------*/
	...
	//新增的attack，在调用父类的attack之前，会先输出一段话
	/**~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
	 * 
	 * The newly added attack will output a paragraph before
	 *  calling the attack of the parent class
	 *  ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
	 */
	public void attack(DungeonCharacter opponent,String msg)
	{
	 ...
	 * ************************************************************
	 */
	public void oneRound(DungeonCharacter opponent, String option2Tip, String attack1Msg) {
		 	System.out.println("1. Attack Opponent");
		    System.out.println("2. " + option2Tip);
		    System.out.print("Choose an option: ");

		    switch (Keyboard.readInt())
		    {
			    case 1: attack(opponent, attack1Msg);
			        break;
			    case 2: option2Attack(opponent);
			        break;
			    default:
	 ...
	 * ************************************************************
	 */
	abstract void option2Attack(DungeonCharacter opponent);
